...
describe('SignInForm Component', () => {
  ...
  it('displays correct title and description', () => {
    ...
    expect(screen.getByText(/sign in to your online banking system account/i)).toBeInTheDocument()
  })
  ...
  it('renders within a centered container', () => {
    ...
    const container = screen.getByRole('button', { name: /sign in with google/i }).closest('.flex')
